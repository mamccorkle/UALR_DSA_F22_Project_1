...
//  This program was written in CLion on a Mac and will vary slightly compared
//  to Visual Studio. The main function uses the code provided within the project
//  specifications and are bound by curly braces to scope each question into its
//  own area. To review each section, you will have to uncomment the section to
//  be reviewed, then debug.
...
int main()
{
    ...
    // Question 3:
    {
        ...
        //Dll_1->addNewNodeToBack(&n18);
        //Dll_1->addNewNodeToBack(&n19);
        //Dll_1->addNewNodeToBack(&n20);
        //Dll_1->addNewNodeToBack(&n21);
        //Dll_1->addNewNodeToBack(&n22);

        //// Test n < 1:
        //Dll_1->split(0);

        //// Test n > number of nodes:
        //Dll_1->split(99);
